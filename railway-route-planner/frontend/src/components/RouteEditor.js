    ...
    const createStopPopupContent = (props, index) => `
        <div style="min-width: 200px;">
            ...
            <div style="margin-bottom: 8px;">
                ...
                <input type="number" id="passengers-in-${index}" min="0" value="${props.passengersIn || 0}" style="width: 60px;">
            </div>
            <div style="margin-bottom: 8px;">
                <label>Pasażerowie wysiadający:</label>
                <input type="number" id="passengers-out-${index}" min="0" value="${props.passengersOut || 0}" style="width: 60px;">
            </div>
            <div style="margin-bottom: 8px;">
                    ...
                    marker.on('popupopen', () => {
                        setTimeout(() => {
                            ...
                            saveBtn.onclick = () => {
                                ...
                                const passengersIn = parseInt(document.getElementById(`passengers-in-${index}`).value) || 0;
                                const passengersOut = parseInt(document.getElementById(`passengers-out-${index}`).value) || 0;
                                ...
                                marker.bindTooltip(
                                    ...
                                    `Wsiadający: ${passengersIn}<br/>` +
                                    `Wysiadający: ${passengersOut}<br/>` +
